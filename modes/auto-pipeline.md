...
1. **Extract form questions:** Use Playwright to navigate to the application form and take a snapshot. If questions can't be extracted, use the generic questions below.
...
Write TSV to `batch/tracker-additions/` and run `node merge-tracker.mjs`. All columns including Report and PDF status.
